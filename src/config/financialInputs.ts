...
export const FINANCIAL_INPUTS: FinancialInputConfig[] = [
  ...
  },
  {
    ...
    tooltip: 'Enable escrow reserves for the project',
    type: 'switch',
    group: 'escrow_contingency',
    defaultValue: false
  },
  {
    ...
    placeholder: '5.0',
    tooltip: 'Percentage of project cost held in escrow',
    type: 'percentage',
    group: 'escrow_contingency',
    defaultValue: 5,
    min: 0,
  ...
  // Zakat & Tax
  {
    ...
    tooltip: 'Apply Islamic Zakat calculations',
    type: 'switch',
    group: 'zakat_tax',
    defaultValue: false
  },
  {
    ...
    label: 'Zakat Rate',
    placeholder: '2.5',
    tooltip: 'Zakat rate percentage (typically 2.5%)',
    type: 'percentage',
    group: 'zakat_tax',
    defaultValue: 2.5,
    min: 0,
