...
INSERT INTO project_milestones (
  ...
  ('demo-compliance-2025', 'Project Kickoff', '2025-03-01', 'completed', 'Project initiation and team mobilization'),
  ('demo-compliance-2025', 'Foundation Complete', '2025-08-15', 'planned', 'Foundation and basement construction completion'),
  ('demo-compliance-2025', '50% Construction', '2026-01-30', 'planned', 'Mid-construction milestone triggering first escrow release'),
  ('demo-compliance-2025', 'Structure Topping', '2026-06-15', 'planned', 'Main structural work completion'),
  ('demo-compliance-2025', 'MEP Installation', '2026-10-30', 'planned', 'Mechanical, electrical, and plumbing systems'),
  ('demo-compliance-2025', 'Fit-out Complete', '2027-02-28', 'planned', 'Interior fit-out and finishing works'),
  ('demo-compliance-2025', 'Project Handover', '2027-04-30', 'planned', 'Final completion and project delivery')
...
INSERT INTO project_contractors (
  ...
  ('demo-compliance-2025', 'Al-Rashid Construction Co.', 'Foundation & Structure', 95000000, 'low', 'active', 'Ahmed Al-Mahmoud', 'ahmed@alrashid.sa', '2025-03-01', '2026-06-15', 'Leading contractor with 25+ years experience in mixed-use developments'),
  ('demo-compliance-2025', 'Modern MEP Systems', 'MEP Installation', 35000000, 'medium', 'planned', 'Sara Al-Zahra', 'sara@modernmep.sa', '2026-04-01', '2026-10-30', 'Specialized in smart building systems and energy efficiency'),
  ('demo-compliance-2025', 'Elite Interiors', 'Fit-out & Finishing', 28000000, 'medium', 'planned', 'Omar Bin Khalid', 'omar@eliteinteriors.sa', '2026-08-01', '2027-02-28', 'Premium interior contractor with international portfolio'),
  ('demo-compliance-2025', 'Riyadh Engineering Consultants', 'Design & Supervision', 12000000, 'low', 'active', 'Dr. Fatima Al-Nasser', 'fatima@rec.sa', '2025-01-15', '2027-04-30', 'Comprehensive engineering and project management services')
ON CONFLICT DO NOTHING;
...
INSERT INTO escrow_releases (
  ...
  ('demo-compliance-2025', '2026-02-15', 28000000, 50.0, 'construction_percent', '50% construction completion verified', 50.0, true),
  ('demo-compliance-2025', '2026-11-30', 16800000, 30.0, 'construction_percent', '80% construction completion verified', 80.0, true),
  ('demo-compliance-2025', '2027-05-15', 11200000, 20.0, 'construction_percent', 'Final completion and handover', 100.0, true)
ON CONFLICT DO NOTHING;
