...
('11111111-1111-1111-1111-111111111111', 'King Salman Mixed-Use Tower', 'Premium mixed-use development in Riyadh Financial District with residential, office, and retail components', 'bee8e7de-357f-4334-a591-978ebb11f446', 'SAR', '2024-01-01', '2026-12-31', true, true, 2.5),
('22222222-2222-2222-2222-222222222222', 'Red Sea Gateway Mall', 'Large-scale shopping and entertainment complex near King Abdulaziz International Airport', 'bee8e7de-357f-4334-a591-978ebb11f446', 'SAR', '2024-03-01', '2025-11-30', true, true, 2.5),
('33333333-3333-3333-3333-333333333333', 'NEOM Smart Residential Complex', 'Futuristic residential development with AI-integrated smart home technology', 'bee8e7de-357f-4334-a591-978ebb11f446', 'SAR', '2024-06-01', '2027-05-31', true, true, 2.5);

-- UAE Projects  
INSERT INTO projects (id, name, description, user_id, currency_code, start_date, end_date, is_demo, zakat_applicable, zakat_rate_percent) VALUES
('44444444-4444-4444-4444-444444444444', 'Dubai Marina Luxury Towers', 'Twin luxury residential towers with marina views and premium amenities', 'bee8e7de-357f-4334-a591-978ebb11f446', 'AED', '2024-02-01', '2026-08-31', true, false, null),
('55555555-5555-5555-5555-555555555555', 'Capital Gate Business Park', 'Modern office complex in Abu Dhabi with sustainable design features', 'bee8e7de-357f-4334-a591-978ebb11f446', 'AED', '2024-04-01', '2025-12-31', true, false, null),
('66666666-6666-6666-6666-666666666666', 'Sharjah Cultural Heritage Center', 'Mixed-use development combining cultural spaces with commercial areas', 'bee8e7de-357f-4334-a591-978ebb11f446', 'AED', '2024-05-01', '2026-03-31', true, false, null);

-- UK Projects
INSERT INTO projects (id, name, description, user_id, currency_code, start_date, end_date, is_demo, zakat_applicable, zakat_rate_percent) VALUES
('77777777-7777-7777-7777-777777777777', 'Canary Wharf Residential Quarter', 'High-end residential development in London financial district', 'bee8e7de-357f-4334-a591-978ebb11f446', 'GBP', '2024-01-15', '2026-09-30', true, false, null),
('88888888-8888-8888-8888-888888888888', 'MediaCity Innovation Hub', 'Tech-focused office and co-working space development', 'bee8e7de-357f-4334-a591-978ebb11f446', 'GBP', '2024-03-15', '2025-10-31', true, false, null);

-- Qatar Projects
INSERT INTO projects (id, name, description, user_id, currency_code, start_date, end_date, is_demo, zakat_applicable, zakat_rate_percent) VALUES
('99999999-9999-9999-9999-999999999999', 'West Bay Premium Offices', 'Grade A office development in Doha West Bay financial district', 'bee8e7de-357f-4334-a591-978ebb11f446', 'QAR', '2024-02-15', '2026-01-31', true, false, null),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Lusail Marina Residential', 'Waterfront residential complex with yacht club and amenities', 'bee8e7de-357f-4334-a591-978ebb11f446', 'QAR', '2024-07-01', '2027-06-30', true, false, null);
