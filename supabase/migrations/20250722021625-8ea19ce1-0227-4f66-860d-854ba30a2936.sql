-- Add comprehensive test data for real-life scenarios with proper date casting
...
-- Complex contractor data with proper date casting
...
-- Complex milestone schedules with proper date casting
